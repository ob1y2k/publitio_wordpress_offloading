...
<div class="publitio-page-wrapper">
  <div class="publitio-page-header">
    <img class="publitio-page-logo" src="<?php echo plugins_url( '/images/publitio_offload.png', dirname(__FILE__)  ); ?>" alt="Publitio" />
  ...
  <div class="publitio-section-wrapper">
    ...
    <div id="pwpo-page-data" class="pwpo-page-data pwpo-requires-auth">
      ...
      <div class="pwpo-page-data-item">
        <div class="publitio-plan-info">
          <span class="pwpo-plan-used">Current plan: <b id="pwpo-plan-used" class="publitio-emphasize">None</b></span>
    ...
    <div class="publitio-settings">
      ...
      <div class="publitio-field-wrapper pwpo-requires-auth">
      ...
      <div class="publitio-field-wrapper publitio-files-wrapper pwpo-requires-auth">
...
<div class="publitio-page-wrapper pwpo-requires-auth">
    <div class="publitio-section-wrapper">
