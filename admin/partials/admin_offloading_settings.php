...
<div class="pwpo-page-wrapper">
  <div class="pwpo-page-header">
    <img class="pwpo-page-logo" src="<?php echo plugins_url( '/images/publitio_offload.png', dirname(__FILE__)  ); ?>" alt="Publitio" />
    <a class="pwpo-page-review" target="_blank" href="https://wordpress.org/plugins/publitio-offloading/#reviews">
      ...
      <div>Please rate us on<br /><span class="pwpo-emphasize">WordPress.org</span></div>
    </a>
  </div>

  <div class="pwpo-section-wrapper">

    <div class="pwpo-page-warning-message">
    ...
    <div id="pwpo-page-data" class="pwpo-page-data pwpo-requires-auth">
      <div class="pwpo-page-data-item">
        <div class="pwpo-storage-chart-container">
          <div class="pwpo-storage-chart" data-percentage="0">
            <div class="pwpo-storage-inner">
              <span class="pwpo-storage-percentage">0%</span>
            </div>
          </div>
        </div>

        <div class="pwpo-storage-info">
          <span class="pwpo-storage-used">Storage used: 0B</span>
          <span class="pwpo-storage-limit">Storage limit: 0B</span>
        </div>
      </div>

      <div class="pwpo-page-data-item">
        <div class="pwpo-bandwidth-chart-container">
          <div class="pwpo-bandwidth-chart" data-percentage="0">
            <div class="pwpo-bandwidth-inner">
              <span class="pwpo-bandwidth-percentage">0%</span>
            </div>
          </div>
        </div>

        <div class="pwpo-bandwidth-info">
          <span class="pwpo-bandwidth-used">Bandwidth used: 0B</span>
          <span class="pwpo-bandwidth-limit">Bandwidth limit: 0B</span>
        </div>
      </div>

      <div class="pwpo-page-data-item">
        <div class="pwpo-plan-info">
          <span class="pwpo-plan-used">Current plan: <b id="pwpo-plan-used" class="pwpo-emphasize">None</b></span>
          <a class="pwpo-button" target="_blank" href="https://publit.io/billing">Manage billing</a>
        </div>
      </div>
    </div>

    <div class="pwpo-settings">
      <div class="pwpo-settings-description">
        <p>
            The Publitio Offloading plugin for WordPress automatically uploads your media files to <a target="_blank" class="pwpo-emphasize" href="https://publit.io/">Publitio's</a> cloud storage instead of keeping them on your WordPress server. Once offloaded, your images, videos, and other files are delivered through <a target="_blank" class="pwpo-emphasize" href="https://publit.io/">Publitio's</a> global CDN, reducing server load, saving hosting space, and speeding up your site. It also gives you access to Publitio's features like on-the-fly transformations, video streaming, and secure file delivery.
        </p>

        <p>
            Check out the tutorial <a target="_blank" class="pwpo-emphasize" href="https://publit.io/community/blog/wordpress-offloading-with-publitio">How to setup Publitio Offloading Wordpress Plugin</a>
        </p>
      </div>
    </div>

    <div class="pwpo-settings-info-title">⚙ Offloading Settings</div>
    ...
    <div class="pwpo-settings">
      ...
      <div class="pwpo-field-wrapper pwpo-files-wrapper pwpo-requires-auth">
        ...
        <div class="pwpo-files-checkbox-wrapper">
            <div class="pwpo-files-checkbox-item">
                <div class="pwpo-checkbox-wrapper">
      ...
      <div class="pwpo-field-wrapper pwpo-requires-auth">
        <label for="pwpo-default-offloading-folder">Upload folder<br />
          <small>Useful if you want to separate offloaded media from the rest of your media</small>
        </label>
        <select id="pwpo-default-offloading-folder" name="pwpo-default-offloading-folder"></select>
      </div>

      <div class="pwpo-field-wrapper pwpo-requires-auth">
        <label for="pwpo-default-offloading-cname">Custom CNAME<br />
          <small>Serve your media from your own domain</small>
        </label>
        <select id="pwpo-default-offloading-cname" name="pwpo-default-offloading-cname"></select>
      </div>
    ...
    <button type="button" class="pwpo-settings-button" id="pwpo-update-offloading-button">Update Settings</button>
  </div>
  <small class="pwpo-version">
    <?php echo PUBLITIO_OFFLOADING_PLUGIN_NAME_VERSION; ?>
  </small>
</div>

<div class="pwpo-page-wrapper pwpo-requires-auth">
    <div class="pwpo-section-wrapper">
        <div class="pwpo-settings-info-title">⚠ Danger Zone</div>
        <div class="pwpo-settings pwpo-border-bottom">
            <div class="pwpo-settings-description">
                <p>
        ...
        <div class="pwpo-buttons-wrapper">
            <button type="button" class="pwpo-settings-button pwpo-warning-button" id="pwpo-update-danger-settings-button">Update Settings</button>
            <button type="button" class="pwpo-settings-button pwpo-danger-button" id="media-delete">Delete All Offloaded Media</button>
        </div>
    </div>
</div>

<div class="pwpo-page-wrapper">
  <div class="pwpo-page-data">
    <div class="pwpo-page-data-item">
      <a class="pwpo-page-footer-block" target="_blank" href="https://dashboard.publit.io/app/dashboards/api-tokens">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 0 0 4.486-6.336l-3.276 3.277a3.004 3.004 0 0 1-2.25-2.25l3.276-3.276a4.5 4.5 0 0 0-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437 1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008Z" /></svg>
        <div>
          <div class="pwpo-emphasize">API Keys</div>
    ...
    <div class="pwpo-page-data-item">
      <a class="pwpo-page-footer-block" target="_blank" href="https://publit.io/community">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" /></svg>
        <div>
          <div class="pwpo-emphasize">Our blog</div>
    ...
    <div class="pwpo-page-data-item">
      <a class="pwpo-page-footer-block" target="_blank" href="https://dashboard.publit.io/app/dashboards/community">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 0 1-.825-.242m9.345-8.334a2.126 2.126 0 0 0-.476-.095 48.64 48.64 0 0 0-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0 0 11.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" /></svg>
        <div>
          <div class="pwpo-emphasize">Community</div>
